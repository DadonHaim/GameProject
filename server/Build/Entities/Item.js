...
class Item extends DB_1.default {
    ...
    constructor(obj) {
        ...
        this.Get_description = () => this.description;
        this.Get_freeze = () => this.freeze;
        this.Get_price = () => this.price;
        this.Get_color = () => this.color;
        this.Get_sale = () => this.sale;
        this.Get_upgrade = () => this.upgrade;
        this.Get_categoryItem = () => this.categoryItem;
